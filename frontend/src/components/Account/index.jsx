...
class Account extends React.Component{
    ...
    constructor(){
        ...
        EngineUsers.personalInformation().then(res => {
            this.setState({
                user: res.username,
            })
        });
    ...
    render(){
        return(
            <div id="treeWrapper" style={containerStyles} ref={tc => (this.treeContainer = tc)}>
                ...
                <Tree onClick={this.testc} translate={this.state.translate} data={myTreeData} orientation={"vertical"} pathFunc={"elbow"} />
